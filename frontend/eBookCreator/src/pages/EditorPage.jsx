...
const handleGenerateChapterContent = async (index) => { 
  ...
  try {
    const response = await axiosInstance.post(API_PATHS.AI.GENERATE_CHAPTER_CONTENT, {
      chapterTitle: chapter.title,
      chapterDescription: chapter.description || '',
      writingStyle: aiStyle || 'Narrative' // ✅ Changed from 'style' to 'writingStyle'
    });
          ...
          <header className='mb-6 md:mb-8'>
            <div className='flex flex-col md:flex-row md:justify-between md:items-center gap-4'>
              ...
              <div className='flex items-center space-x-3'>
                <button
                  onClick={() => setIsSidebarOpen(true)}
                  className='md:hidden p-2.5 rounded-xl bg-white hover:bg-violet-50 border border-gray-200 hover:border-violet-200 transition-all duration-200 shadow-sm hover:shadow-md'
                >
                  <Menu className='w-5 h-5 text-gray-700' />
                </button>
                ...
                <div className='flex bg-white rounded-xl border border-gray-200 shadow-sm p-1'>
                  <button 
                    className={`flex items-center justify-center px-4 py-2.5 text-sm font-semibold rounded-lg transition-all duration-200 ${
                      activeTab === 'editor' 
              ...
              <div className='flex items-center gap-2 md:gap-3 z-50'>
                ...
                <Dropdown 
                  trigger={
                    <button className='inline-flex items-center px-4 py-2.5 text-sm font-semibold text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 shadow-sm hover:shadow-md'>
